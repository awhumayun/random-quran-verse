  ...
  [429],
  {
    2167: function () {
        ...
        class P {
          ...
          then(e, n) {
            ...
            const r = new o(S),
              s = t.current;
            return (
              null == this[g] ? this[_].push(s, r, e, n) : Z(this, s, r, e, n),
              r
            );
          }
          catch(e) {
            ...
            const r = t.current;
            return (
              null == this[g] ? this[_].push(r, o, e, e) : Z(this, r, o, e, e),
              o
            );
          }
        }
          ...
          const P = p
            ...
            A = function (t, n, r, s, a = !1, i = !1) {
              return function () {
                ...
                if (S) {
                  if (((P = !0), _))
                    for (let e = 0; e < S.length; e++) if (z(S[e], u)) return;
                } else S = c[w] = [];
                ...
                const L = p ? M : void 0;
                L && (L.taskData = T);
                const A = b.scheduleEventTask(Z, u, L, r, s);
                return (
                  (T.target = null),
                  L && (L.taskData = null),
                  y && (d.once = !0),
      ...
      function oe(e, t) {
        ...
        s && ne(s.prototype, Y, r);
        const a = t.XMLHttpRequestEventTarget;
        a && ne(a && a.prototype, Y, r),
          "undefined" != typeof IDBIndex &&
            (ne(IDBIndex.prototype, J, r),
            ne(IDBRequest.prototype, J, r),
            ne(IDBOpenDBRequest.prototype, J, r),
            ne(IDBDatabase.prototype, J, r),
            ne(IDBTransaction.prototype, J, r),
            ne(IDBCursor.prototype, J, r)),
                  ...
                  try {
                    ...
                    e.isPeriodic ||
                      ("number" == typeof e.handleId
                        ? delete a[e.handleId]
                        : e.handleId && (e.handleId[re] = null));
                  }
                };
                const r = l(t, s[0], e, i, c);
                if (!r) return r;
                const u = r.data.handleId;
                return (
                  "number" == typeof u ? (a[u] = r) : u && (u[re] = r),
                  u &&
                    u.ref &&
                    u.unref &&
                    "function" == typeof u.ref &&
                    "function" == typeof u.unref &&
                    ((r.ref = u.ref.bind(u)), (r.unref = u.unref.bind(u))),
                  "number" == typeof u || u ? u : r
                );
              }
              return n.apply(e, s);
            },
                ...
                "number" == typeof r
                  ...
                  s && "string" == typeof s.type
                    ? "notScheduled" !== s.state &&
                      ...
                      ("number" == typeof r ? delete a[r] : r && (r[re] = null),
                      s.zone.cancelTask(s))
                    : t.apply(e, o);
              },
          ));
      ...
      Zone.__load_patch("legacy", (e) => {
        ...
        Zone.__load_patch("MutationObserver", (e, t, n) => {
          S("MutationObserver"), S("WebKitMutationObserver");
        }),
